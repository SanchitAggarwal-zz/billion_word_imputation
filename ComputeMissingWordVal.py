...
for line in validationset:
	...
	if Original_Missing_word == missing_word:
		Accuracy_Word = Accuracy_Word + 1
...
print "Accuracy_Word: ",Accuracy_Word 
print "AccuracyMissingWord: ", Accuracy_Word*100/float(line_id)